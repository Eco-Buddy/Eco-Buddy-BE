...
@Getter
@Table(name = "hourly_data_usage",
        indexes = {
        @Index(name = "idx_device_id", columnList = "device_id"),
        @Index(name = "idx_usage_time", columnList = "usage_time")
})
public class HourlyDataUsage {
    ...
    @Builder
    public HourlyDataUsage(Long id, Device deviceId, LocalDateTime usageTime, Double dataUsed, Double wifiUsed) {
        this.id = id;
